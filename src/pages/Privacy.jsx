    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <Section title="7. Your Rights">
          ...
          <p>Contact us at <a href="mailto:info@cointehera.com" className="text-[#0052FF] no-underline hover:underline">info@cointehera.com</a> to exercise these rights.</p>
        </Section>
        ...
        <Section title="10. Contact">
          <p>Privacy questions: <a href="mailto:info@cointehera.com" className="text-[#0052FF] no-underline hover:underline">info@cointehera.com</a></p>
        </Section>
