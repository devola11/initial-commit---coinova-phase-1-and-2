    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <Section title="11. Contact">
          <p>For questions about these terms, contact us at: <a href="mailto:info@cointehera.com" className="text-[#0052FF] no-underline hover:underline">info@cointehera.com</a></p>
        </Section>
